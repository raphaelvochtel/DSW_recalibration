...
hold on
load wo.mat
plot((oo_.irfs.wLl_eps_tauIMH(1:20)/eqlbm_ss0.wLl_fixed)*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
...
load wo.mat
hold on
plot((oo_.irfs.wHl_eps_tauIMH(1:20)/eqlbm_ss0.wHl_fixed)*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
...
hold on
load wo.mat
plot((oo_.irfs.wLh_eps_tauIMH(1:20)/eqlbm_ss0.wLh_fixed)*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
...
hold on
load wo.mat
plot((oo_.irfs.wHh_eps_tauIMH(1:20)/eqlbm_ss0.wLh_fixed)*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
...
load wo.mat
hold on
plot([0,oo_.irfs.massL_eps_tauIMH(1:19)/eqlbm_ss0.masses(1)]*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
...
hold on
load wo.mat
plot([0,oo_.irfs.massH_eps_tauIMH(1:19)/eqlbm_ss0.masses(2)]*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
...
hold on
load wo.mat
plot((oo_.irfs.mass_XL_eps_tauIMH(1:20)/eqlbm_ss0.masses(7))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
...
hold on
load wo.mat
plot((oo_.irfs.mass_XH_eps_tauIMH(1:20)/eqlbm_ss0.masses(8))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
...
hold on
load wo.mat
plot((oo_.irfs.mass_EL_eps_tauIMH(1:20)/eqlbm_ss0.masses(9))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
...
hold on
load wo.mat
plot((oo_.irfs.mass_EH_eps_tauIMH(1:20)/eqlbm_ss0.masses(10))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
...
hold on
load wo.mat
plot((oo_.irfs.CLl_eps_tauIMH(1:20)/eqlbm_ss0.hh(4))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
...
hold on
load wo.mat
plot((oo_.irfs.CHl_eps_tauIMH(1:20)/eqlbm_ss0.hh(2))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
...
hold on
load wo.mat
plot((oo_.irfs.CLh_eps_tauIMH(1:20)/eqlbm_ss0.hh(3))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
...
hold on
load wo.mat
plot((oo_.irfs.CHh_eps_tauIMH(1:20)/eqlbm_ss0.hh(1))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
title('($C^{Hh}$)','FontSize',6,'Interpreter','latex')

legend('With offshoring', 'Without offshoring','Interpreter','latex','position',[0.5 0.02 0.005 0.005], 'NumColumns', 4, 'FontSize',6)
saveas(figure(1), [pwd '/Northshock_North_2sec1_wo_10Sep2025.eps'],'epsc');
...
hold on
load wo.mat
plot((oo_.irfs.Q_eps_tauIMH(1:20)/solve(1))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
...
hold on
load wo.mat
plot((oo_.irfs.VHh_eps_tauIMH(1:20)/eqlbm_ss0.hh(19))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
...
hold on
load wo.mat
plot((oo_.irfs.VHl_eps_tauIMH(1:20)/eqlbm_ss0.hh(20))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
...
hold on
load wo.mat
plot((oo_.irfs.VLh_eps_tauIMH(1:20)/eqlbm_ss0.hh(21))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
...
hold on
load wo.mat
plot((oo_.irfs.VLl_eps_tauIMH(1:20)/eqlbm_ss0.hh(22))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
...
hold on
load wo.mat
plot((oo_.irfs.h_supplyH_eps_tauIMH(1:20)/eqlbm_ss0.agg(17))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
...
hold on
load wo.mat
plot((oo_.irfs.h_supplyL_eps_tauIMH(1:20)/eqlbm_ss0.agg(16))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
...
hold on
load wo.mat
plot((oo_.irfs.l_supplyH_eps_tauIMH(1:20)/eqlbm_ss0.agg(6))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
...
hold on
load wo.mat
plot((oo_.irfs.l_supplyL_eps_tauIMH(1:20)/eqlbm_ss0.agg(7))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
...
hold on
load wo.mat
plot((oo_.irfs.psiH_eps_tauIMH(1:20)/eqlbm_ss0.psiH_fixed)*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
...
hold on
load wo.mat
plot((oo_.irfs.psiL_eps_tauIMH(1:20)/eqlbm_ss0.psiL_fixed)*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
...
hold on
load wo.mat
plot((oo_.irfs.HhE_supply_eps_tauIMH(1:20)/eqlbm_ss0.hh(27))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
...
hold on
load wo.mat
plot((oo_.irfs.HlE_supply_eps_tauIMH(1:20)/eqlbm_ss0.hh(28))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
...
hold on
load wo.mat
plot((oo_.irfs.LhE_supply_eps_tauIMH(1:20)/eqlbm_ss0.hh(33))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
...
hold on
load wo.mat
plot((oo_.irfs.LlE_supply_eps_tauIMH(1:20)/eqlbm_ss0.hh(34))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
...
hold on
load wo.mat
plot(ToTH_eps_tauIMH(1:20)/ToTH_SS*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
title('($ToT^{H}$)','FontSize',6,'Interpreter','latex')


legend('With offshoring', 'Without offshoring','Interpreter','latex','position',[0.50 0.02 0.005 0.005], 'NumColumns', 4, 'FontSize',6)
saveas(figure(2), [pwd '/Northshock_North_2sec2_wo_10Sep2025.eps'],'epsc');
...
hold on
load wo.mat
plot((oo_.irfs.wLl_star_eps_tauIMH(1:20)/eqlbm_ss0.wLl_star_fixed)*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
title('($w^{Ll*}$)','FontSize',6,'Interpreter','latex')
...
hold on
load wo.mat
plot((oo_.irfs.wHl_star_eps_tauIMH(1:20)/eqlbm_ss0.wHl_star_fixed)*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
title('($w^{Hl*}$)','FontSize',6,'Interpreter','latex')
...
hold on
load wo.mat
plot((oo_.irfs.wLh_star_eps_tauIMH(1:20)/eqlbm_ss0.wLh_fixed)*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
title('($w^{Lh*}$)','FontSize',6,'Interpreter','latex')
...
hold on
load wo.mat
plot((oo_.irfs.wHh_star_eps_tauIMH(1:20)/eqlbm_ss0.wHh_fixed)*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
title('($w^{Hh*}$)','FontSize',6,'Interpreter','latex')
...
hold on
load wo.mat
plot([0,oo_.irfs.massL_star_eps_tauIMH(1:19)/eqlbm_ss0.masses(11)]*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
title('($N^{L*}$)','FontSize',6,'Interpreter','latex')
...
hold on
load wo.mat
plot([0,oo_.irfs.massH_star_eps_tauIMH(1:19)/eqlbm_ss0.masses(12)]*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
title('($N^{H*}$)','FontSize',6,'Interpreter','latex')
...
hold on
load wo.mat
plot((oo_.irfs.mass_XL_star_eps_tauIMH(1:20)/eqlbm_ss0.masses(17))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
...
hold on
load wo.mat
plot((oo_.irfs.mass_XH_star_eps_tauIMH(1:20)/eqlbm_ss0.masses(18))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
...
hold on
load wo.mat
plot((oo_.irfs.mass_EL_star_eps_tauIMH(1:20)/eqlbm_ss0.masses(19))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
...
hold on
load wo.mat
plot((oo_.irfs.mass_EH_star_eps_tauIMH(1:20)/eqlbm_ss0.masses(20))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
...
hold on
load wo.mat
plot((oo_.irfs.CLl_star_eps_tauIMH(1:20)/eqlbm_ss0.hh(8))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
title('($C^{Ll*}$)','FontSize',6,'Interpreter','latex')
...
hold on
load wo.mat
plot((oo_.irfs.CHl_star_eps_tauIMH(1:20)/eqlbm_ss0.hh(6))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
title('($C^{Hl*}$)','FontSize',6,'Interpreter','latex')
...
hold on
load wo.mat
plot((oo_.irfs.CLh_star_eps_tauIMH(1:20))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
title('($C^{Lh*}$)','FontSize',6,'Interpreter','latex')
...
hold on
load wo.mat
plot((oo_.irfs.CHh_star_eps_tauIMH(1:20)/eqlbm_ss0.hh(5))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
title('($C^{Hh*}$)','FontSize',6,'Interpreter','latex')
legend('With offshoring', 'Without offshoring','Interpreter','latex','position',[0.50 0.02 0.005 0.005], 'NumColumns', 4, 'FontSize',6)
saveas(figure(3), [pwd '/Northshock_South_2sec1_wo_10Sep2025.eps'],'epsc');
...
hold on
load wo.mat
plot((oo_.irfs.VHh_star_eps_tauIMH(1:20)/eqlbm_ss0.hh(23))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
title('($V^{Hh*}$)','FontSize',6,'Interpreter','latex')
...
hold on
load wo.mat
plot((oo_.irfs.VHl_star_eps_tauIMH(1:20)/eqlbm_ss0.hh(24))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
title('($V^{Hl*}$)','FontSize',6,'Interpreter','latex')
...
hold on
load wo.mat
plot((oo_.irfs.VLh_star_eps_tauIMH(1:20)/eqlbm_ss0.hh(25))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
title('($V^{Lh*}$)','FontSize',6,'Interpreter','latex')
...
hold on
load wo.mat
plot((oo_.irfs.VLl_star_eps_tauIMH(1:20)/eqlbm_ss0.hh(26))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
title('($V^{Ll*}$)','FontSize',6,'Interpreter','latex')
...
hold on
load wo.mat
plot((oo_.irfs.h_supplyH_star_eps_tauIMH(1:20)/eqlbm_ss0.agg(19))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
title('($H^{H*}$)','FontSize',6,'Interpreter','latex')
...
hold on
load wo.mat
plot((oo_.irfs.h_supplyL_star_eps_tauIMH(1:20)/eqlbm_ss0.agg(18))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
title('($H^{L*}$)','FontSize',6,'Interpreter','latex')
...
hold on
load wo.mat
plot((oo_.irfs.l_supplyH_star_eps_tauIMH(1:20)/eqlbm_ss0.agg(8))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
title('($L^{H*}$)','FontSize',6,'Interpreter','latex')
...
hold on
load wo.mat
plot((oo_.irfs.l_supplyL_star_eps_tauIMH(1:20)/eqlbm_ss0.agg(7))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
title('($L^{L*}$)','FontSize',6,'Interpreter','latex')
...
hold on
load wo.mat
plot((oo_.irfs.psiH_star_eps_tauIMH(1:20)/eqlbm_ss0.psiH_star_fixed)*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
title('($\psi^{H*}$)','FontSize',6,'Interpreter','latex')
...
hold on
load wo.mat
plot((oo_.irfs.psiL_star_eps_tauIMH(1:20)/eqlbm_ss0.psiL_star_fixed)*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
title('($\psi^{L*}$)','FontSize',6,'Interpreter','latex')
...
hold on
load wo.mat
plot((oo_.irfs.HhE_supply_star_eps_tauIMH(1:20)/eqlbm_ss0.hh(31))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
title('($H^{H*}_{E}$)','FontSize',6,'Interpreter','latex')
...
hold on
load wo.mat
plot((oo_.irfs.HlE_supply_star_eps_tauIMH(1:20)/eqlbm_ss0.hh(32))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
title('($H^{L*}_{E}$)','FontSize',6,'Interpreter','latex')
...
hold on
load wo.mat
plot((oo_.irfs.LhE_supply_star_eps_tauIMH(1:20)/eqlbm_ss0.hh(33))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
title('($L^{H*}_{E}$)','FontSize',6,'Interpreter','latex')
...
hold on
load wo.mat
plot((oo_.irfs.LlE_supply_star_eps_tauIMH(1:20)/eqlbm_ss0.hh(34))*100,'-^', 'LineWidth',1.5,'color', [0 0.4470 0.7410], 'MarkerSize',6,'MarkerIndices', 1:4:20)
title('($L^{L*}_{E}$)','FontSize',6,'Interpreter','latex')
...
legend('With offshoring', 'Without offshoring','Interpreter','latex','position',[0.50 0.02 0.005 0.005], 'NumColumns', 4, 'FontSize',6)
saveas(figure(4), [pwd '/Northshock_South_2sec2_wo_10Sep2025.eps'],'epsc');
